...
@push('styles') <!-- Esto es para hacer el llamado a ese push que este en app -->
        ...
        <div class="md:w-1/2 px-10 bg-white p-10 rounded-lg shadow-xl mt-10 md:mt-0">
            <form action="{{ route('post.store') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="titulo" id="titulo" placeholder="Ingresa el titulo" class="border p-3 w-full rounded-lg @error('titulo')
                ...
                <div class="mb-5">
                    ...
                    <textarea name="descripcion" id="descripcion" placeholder="Descripcion de la publicación" class="border p-3 w-full rounded-lg @error('descripcion')

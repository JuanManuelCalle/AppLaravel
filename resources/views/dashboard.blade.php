...
@section('contenido')
    <div class="flex justify-center">
        <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            ...
            <div class="md:w-8/12 lg:w-6/12 px-5 flex flex-col items-center md:justify-center md:items-start py-10 md:py-10">
                ...
                <p class="text-gray-800 text-sm mb-3 font-bold">
                    {{ $user->posts->count() }} {{-- Vamos a mostrar cuantos post tiene un usuario --}}
    ...
    {{-- Creando la seccion para mostrar la informacion --}}
    <section class="container mx-auto mt-10">
        <h2 class="text-4xl text-center font-black my-10">Publicaciones</h2>
        {{-- Esto es ppara que si no hay ninguna publicacion del usuario nos muestre un mensaje de que no hay publicaciones --}}
